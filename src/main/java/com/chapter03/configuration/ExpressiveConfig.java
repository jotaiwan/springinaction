...
import com.beans.music.BlankDiskSpEL;
...
public class ExpressiveConfig {
    ...
    @Bean
    public BlankDiskSpEL blankDiskSpEL() {
        return new BlankDiskSpEL(environment.getProperty("disc.title"), environment.getProperty("disc.artist"));
    }
